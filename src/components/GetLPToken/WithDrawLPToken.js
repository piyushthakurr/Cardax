                    ...
                    <Col className="lp_tokens">
                        <Form className="lptokn_area">
                            ...
                            <div className="confirmation">
                                ...
                                <Button disabled={props.stakeConfirmation} onClick={() => checkIfAmountGreaterThanWithdrawable(props.stakeValue, props.stakeData.isLocked)} className="cm_btn confirm">Confirrm</Button>
                            </div>
                        </Form>
                    </Col>
                </Row>
